...
from groupn import MyCompany
from grouptest import FakeCompany
...
def build_specification():
    ...
    fake_fleet = fleets.mixed_fleet(num_suezmax=num_suezmax, num_aframax=num_aframax, num_vlcc=num_vlcc)
    specifications_builder.add_company(FakeCompany.Data(FakeCompany, fake_fleet, "Imposter Company"))
